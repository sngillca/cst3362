            ...
            for(var a = 0; a < data.length; a++){
                ...
                if(lastName == lastNamedb || firstName == firstNamedb){
                    ...
                    if(data[a].gender == "male"){
                        html += "<br><h2><em><kbd>Wizard: <mark>"+data[a].name+"</mark> Patronus:<strong> "+data[a].patronus.toUpperCase()+"</strong> House: <strong>"+data[a].house+"</strong></kbd></em></h2><br>";
                       var path = data[a].image;
                        html += "<br><img src='"+path+"'  height='300' width='300'></img>";
                    }
                    if(data[a].gender == "female"){
                        
                        html += "<br><h2><em><kbd>Witch: <mark>"+data[a].name+"</mark> Patronus:<strong> "+data[a].patronus.toUpperCase()+"</strong> House: <strong>"+data[a].house+"</strong></kbd></em></h2><br>"+data[a].image;
                       // var path = "../img/"+a+".jpg";
                       // html += "<br><img src='"+path+"'  height='300' width='300'></img>";
                     }//end gender
                 } //end names
